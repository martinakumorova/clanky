...
class TermController extends Controller
{
    ...
    public function actionOrder($id_term, $ambulance_id_ambulance)
    {
        $model = $this->findModel($id_term);
        $model->user_id_user = Yii::$app->getUser()->getId();
        $model->save();
        return $this->redirect(['ambulance/view', 'id' => $ambulance_id_ambulance]);

    }

    public function actionCancelOrder($id_term, $ambulance_id_ambulance)
    {
        $model = $this->findModel($id_term);
